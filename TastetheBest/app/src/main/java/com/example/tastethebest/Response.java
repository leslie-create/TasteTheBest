...
public class Response extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbRatings = FirebaseDatabase.getInstance().getReference("Ratings").child(recipeName);
    ...
    private void getRating() {
        dbRatings.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ratingsAdapter = new RatingsAdapter(Response.this, ratingArrayList);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rating.equalsIgnoreCase("0.0")) {
                    Toast.makeText(Response.this, "Please add rating", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (comment.isEmpty()) {
                    Toast.makeText(Response.this, "Please add comment", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                dbRatings.child(key).setValue(rate).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        getRating();
                        Toast.makeText(Response.this, "Added rating!", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
