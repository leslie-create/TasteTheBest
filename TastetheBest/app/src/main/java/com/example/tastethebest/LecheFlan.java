...
public class LecheFlan extends AppCompatActivity {
...
//    private Button mResponseBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leche_flan);
...
//        });
        ...
        mRateme.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),Response.class).putExtra("recipeName","leche flan"));
